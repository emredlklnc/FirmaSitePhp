              ...
              <div class="menu_section">
               ...
               <ul class="nav side-menu">
                ...
                <ul class="nav side-menu">
                 ...
                 <ul class="nav side-menu">
                  <li><a><i class="fa fa-user"></i>My Team<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                    <li><a href="team.php"><i ></i>Çalışanlar</a></li>
                    <li><a href="team-ekle.php"><i ></i>Çalışan Ekle</a></li> 
                    </ul>
                  </li>   
                </ul>
                ...
                <ul class="nav side-menu">
                  <li><a href="reklamresim-guncelle.php"><i class="fa fa-youtube"></i>Reklam Resmi</a></li>     
                </ul>
