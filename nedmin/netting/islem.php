...
if (isset($_POST['hakguncelle'])) 
{
	...
	else
	{
				...
				$mailayarkaydet=$db->prepare("UPDATE hakkimizda SET hakkimizda_baslik='$hakkimizda_baslik',hakkimizda_altbaslik='$hakkimizda_altbaslik' ,hakkimizda_resim='$eskiresim',hakkimizda_icerik='$hakkimizda_icerik',hakkimizda_vizyon='$hakkimizda_vizyon',hakkimizda_misyon='$hakkimizda_misyon' WHERE hakkimizda_id=0");
				$mailayarguncelle=$mailayarkaydet->execute();
...
if (isset($_POST['reklamguncelle'])) 
{
	...
	if ($_FILES['reklam_resimyol']['size']>0) 
	{
				...
				$uploads_dir="../../upload/reklamresim";
				...
				$reklam_alan1=$_POST['reklam_alan1'];
				$reklam_alan2=$_POST['reklam_alan2'];
				$reklam_alan3=$_POST['reklam_alan3'];
				$reklam_alan4=$_POST['reklam_alan4'];
				$reklam_alan1deger=$_POST['reklam_alan1deger'];
				$reklam_alan2deger=$_POST['reklam_alan2deger'];
				$reklam_alan3deger=$_POST['reklam_alan3deger'];
				$reklam_alan4deger=$_POST['reklam_alan4deger'];
				$reklam_ad=$_POST['reklam_ad'];
				
				
				$reklamguncelle=$db->prepare("UPDATE reklamresim SET reklam_ad='$reklam_ad',reklam_alan1='$reklam_alan1',reklam_alan2='$reklam_alan2',reklam_alan3='$reklam_alan3',reklam_alan4='$reklam_alan4',reklam_alan1deger='$reklam_alan1deger',reklam_alan2deger='$reklam_alan2deger',reklam_alan3deger='$reklam_alan3deger',reklam_alan4deger='$reklam_alan4deger',reklam_resimyol='$refimgyol' WHERE reklam_id=0");
				$guncelle=$reklamguncelle->execute();


				if ($guncelle) 
				{
					header("Location:../reklamresim-guncelle.php?reklam_id=0&durum=ok");
				}
				else
				{
					header("Location:../reklamresim-guncelle.php?reklam_id=0&durum=no");
				}
	...
	else
	{
			...
			$reklam_alan1=$_POST['reklam_alan1'];
				...
				$reklamguncelle=$db->prepare("UPDATE reklamresim SET reklam_ad='$reklam_ad',reklam_alan1='$reklam_alan1',reklam_alan2='$reklam_alan2',reklam_alan3='$reklam_alan3',reklam_alan4='$reklam_alan4',reklam_alan1deger='$reklam_alan1deger',reklam_alan2deger='$reklam_alan2deger',reklam_alan3deger='$reklam_alan3deger',reklam_alan4deger='$reklam_alan4deger',reklam_resimyol='$eskiresim' WHERE reklam_id=0");
				$guncelle=$reklamguncelle->execute();
...
if (isset($_POST['teamguncelle'])) 
{

	$eskiresim=$_POST['eskiresimyol'];
	if ($_FILES['team_resimyol']['size']>0) 
	{
				
				unlink("../../$eskiresim");
		
				$uploads_dir="../../upload/team";
				@$tmp_name=$_FILES['team_resimyol']["tmp_name"];
				@$name=$_FILES['team_resimyol']["name"];
				$benzersizsayi1=rand(20000,32000);
				$benzersizsayi2=rand(20000,32000);
				$benzersizsayi3=rand(20000,32000);
				$benzersizsayi4=rand(20000,32000);
				...
				$team_adsoyad=$_POST['team_adsoyad'];
				$team_meslek=$_POST['team_meslek'];
				$team_t=$_POST['team_t'];
				$team_f=$_POST['team_f'];
				$team_g=$_POST['team_g'];
				$team_in=$_POST['team_in'];
				
				$teamguncelle=$db->prepare("UPDATE team SET team_adsoyad='$team_adsoyad',team_meslek='$team_meslek',team_t='$team_t',team_f='$team_f',team_g='$team_g',team_in='$team_in',team_resimyol='$refimgyol' WHERE team_id='$team_id'");
				...
				if ($guncelle) 
				{
					header("Location:../team-guncelle.php?team_id=$team_id&durum=ok");
				}
				else
				{
					header("Location:../team-guncelle.php?team_id=$team_id&durum=no");
				}
	...
	else
	{
				...
				$teamguncelle=$db->prepare("UPDATE team SET team_adsoyad='$team_adsoyad',team_meslek='$team_meslek',team_t='$team_t',team_f='$team_f',team_g='$team_g',team_in='$team_in',team_resimyol='$eskiresim' WHERE team_id='$team_id'");
...
if (isset($_POST['teamkaydet'])) 
{
				...
				$teamekle=$db->prepare("INSERT INTO team SET team_adsoyad='$team_adsoyad',team_meslek='$team_meslek' ,team_t='$team_t',team_f='$team_f',team_g='$team_g',team_in='$team_in',team_resimyol='$refimgyol'");

				$insert=$teamekle->execute();

				if ($insert) 
				{
					header("Location:../team.php?durum=ok");
				}
				else
				{
					header("Location:../team.php?durum=no");
				}
